...
def test_corpora():
    ...
    decade_corpus, recovery_measures = corpus_cleaner.cleanup_and_create_decade_corpus(raw_documents)
    # data_saver.create_decade_corpus(decade_corpus, f'{start_year}_filtered')
